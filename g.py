...
TOKEN = '7710304823:AAGV_B3mMRNKTpHGTYIPGEQS1Ch02P8rgoA' #Enter_Bot_Token_within_the_colons'
MONGO_URI = 'mongodb+srv://deepaidb:51354579914@deepaidb.imzonfj.mongodb.net/?retryWrites=true&w=majority&appName=deepaidb'
FORWARD_CHANNEL_ID = -1002401924352        # enter the log channel id 
CHANNEL_ID = -1002401924352          # enter the same id as entered above
error_channel_id = -1002401924352          # enter the same id 
